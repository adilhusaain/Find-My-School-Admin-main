...
export default function AdminLog() {
  ...
  async function deleteInstitute(id){
   await firebase.firestore().collection('test').doc(id).delete().then(alert("deleted")).catch((error)=>alert(error))
 ...
 <TableCell> 
     <Button  color="secondary" onClick={deleteInstitute}>Delete</Button> 
