...
export default function AddAdmin() {
  ...
  async function handleUpload(values) {
    ...
    const op= values.openingTiming.moment()
    const cp= values.closingTiming.moment()
    const fp = values.fridayTiming.moment()

    values.openingTiming = op
    values.closingTiming=cp
    values.fridayTiming=fp
