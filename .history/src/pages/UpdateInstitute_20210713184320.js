...
export default function UpdateInstitute({match}) {
  ...
  const id = String(match.params.selected).toString()
  ...
  async function loadData(){
      const userRef = firebase.firestore().collection('test').doc(id).get()
      console.log(userRef.data())  
      setListings({data:userRef.data()})
  }
  useEffect(()=>{
loadData();
  },[])
